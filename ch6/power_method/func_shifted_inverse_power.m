function [u] = func_shifted_inverse_power(A,u,shift,max_iter)
% FUNC_SHIFTED_INVERSE_POWER Inverse power method to compute largest eigenpair
% --------------------
% Usage
% [U,EXITFLAT,ITER] = FUNC_SHIFTED_INVERSE_POWER(A,U)
% [U,EXITFLAT,ITER] = FUNC_SHIFTED_INVERSE_POWER(A,U,OPTIONS) 
...
if nargin < 3
    ...
    msgtext = "func_inverse_power should at least receive A, u and shift";
...
% shift
A = A - shift*eye(n,n);
[u,lambda,exitflag,output] = func_inverse_power(A,u,options);
end
